...
这是一个适合大二计算机专业初学者的“人脸美化系统”项目，完整实现了课程设计题目中的所有项目一功能。
...
### Q: 运行时提示"无法加载人脸检测级联分类器"
A: 确保OpenCV正确安装，检查`cv2.data.haarcascades`路径是否存在

### Q: 加载图片失败
A: 检查图片格式是否支持，路径是否正确，文件是否损坏

### Q: 处理后图像显示异常
A: 检查OpenCV和Pillow版本兼容性，尝试重启程序
